...
void man(char *name)
{
    ...
    if(strcmp(name,"create")==0)
    {
        ...
        printf("Usege : create File_name Permission\n");
    }
    else if(strcmp(name,"read")==0)
    {
        printf("Description : Used to readdata friom regular file\n");
    ...
    else if(strcmp(name,"write")==0)
    {
        ...
        printf("Usage : write File_name\nAfter this enter the data that wewant to write\n");

    }
    else if(strcmp(name,"ls")==0)
    {
        printf("Description : Used to lidt all information of file\n");
        printf("Usage : ls\n");
    ...
    {
        printf("Description : Used to rempve information from  file\n");
...
void DisplayHelp()
{
    ...
    printf("exit : To Display information of file using name\n");
    printf("stat : To Display informaion of file using name\n");
    printf("fstat : To Display informaion of file Descriptor\n");
    printf("truncate : To Rempve all data from file\n");
...
int WireFile(int fd,char *arr,int isize)
{
...
int fstat_file(int fd)
{
    ...
    printf("Link count :%d\n",temp->LinkCount);
    printf("Reference code :%d\n",temp->ReferenceCount);

    if(temp->Permission == 1)
    {
        printf("File Prermission :Read only\n");
    }
    else if(temp->Permission==2)
        printf("File Prermission :Write\n");
    else if(temp->Permission==3)
        printf("File Prermission :Read & Write\n");
        ...
        if(count == 1)
        {
            ...
            else if(count==2)
            {
                ...
                else if(strcmp(command[0],"write")==0)
                {
                    ...
                    ret =WireFile(fd,arr,ret);
                    if(ret==-1)
                        printf("ERROR : Permissino denide\n");
                    if(ret ==-2)
